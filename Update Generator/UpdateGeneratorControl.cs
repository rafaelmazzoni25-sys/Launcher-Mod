...
{
    public partial class UpdateGeneratorControl : UserControl
    {
        ...
        public UpdateGeneratorControl()
        {
            InitializeComponent();
        }

        public string? SelectedPath => string.IsNullOrEmpty(_selectedPath) ? null : _selectedPath;

        public ManifestBuildResult LastBuild => _lastBuild;

        public void SetSourcePath(string path)
        {
            _selectedPath = path ?? string.Empty;
            filePath.Text = string.IsNullOrEmpty(_selectedPath) ? string.Empty : NormalizePath(_selectedPath);
        }
        ...
        {
            if (string.IsNullOrEmpty(_selectedPath) || backgroundWorker.IsBusy)
            {
                return;
            }
