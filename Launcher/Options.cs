...
namespace Launcher
{
  public class Options : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.comboBox2.Location = new Point(240, 229);
      ...
      this.label2.Location = new Point(58, 208);
      ...
      this.label3.Location = new Point(237, 208);
      ...
      this.m_Resolution_S12.Location = new Point(170, 192);
